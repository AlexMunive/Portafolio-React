            ...
            <div className='contact__content'>
                ...
                <div className='contact__info'>
                    ...
                    <div className='contact__card'>
                     ...
                     <a href="mailto:alexmunive.0213@gmail.com" className='contact__button'>Write me 
                    ...
                    <i className='bx bxl-whatsapp contact__card-icon'></i>
                     ...
                     <span className='contact__card-data'>+51 933528790</span>
                     <a href="https://api.whatsapp.com/send?phone=933528790&text=Que tal Alexander, tenga un cordial saludos 🖐." target="_blank" className='contact__button'>Write me 
                     <i className='bx bx-right-arrow-alt contact__button-icon'></i></a>
                    </div>
            ...
            <div className='contact__content'>
                ...
                <form className='contact__form' ref={form} onSubmit={sendEmail}>
                    ...
                    <div className='contact__form-div contact__form-area'>
                        ...
                        className='contact__form-input' placeholder='Tell me your big idea' required/>
                    </div>
                    <button className='button button--flex'>Send Message<i className='bx bxs-navigation'></i></button>
                    <div className='contact__button-result'>{result ? <Result/> : null}</div>
                </form>
            </div>
        </div>
    </section>
